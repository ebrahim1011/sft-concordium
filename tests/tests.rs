//! Tests for the `sft_market` contract.
use sft_market::*;
use concordium_cis2::*;
...
fn test_minting() {
    ...
    let invoke = chain
        .contract_invoke(ALICE, ALICE_ADDR, Energy::from(10000), UpdateContractPayload {
            amount:       Amount::zero(),
            receive_name: OwnedReceiveName::new_unchecked("sft_market.view".to_string()),
...
fn test_account_transfer() {
    ...
    let update = chain
        .contract_update(SIGNER, ALICE, ALICE_ADDR, Energy::from(10000), UpdateContractPayload {
            amount:       Amount::zero(),
            receive_name: OwnedReceiveName::new_unchecked("sft_market.transfer".to_string()),
            address:      contract_address,
...
fn test_add_operator() {
    ...
    let update = chain
        .contract_update(SIGNER, ALICE, ALICE_ADDR, Energy::from(10000), UpdateContractPayload {
            amount:       Amount::zero(),
            receive_name: OwnedReceiveName::new_unchecked("sft_market.updateOperator".to_string()),
            address:      contract_address,
    ...
    let invoke = chain
        .contract_invoke(ALICE, ALICE_ADDR, Energy::from(10000), UpdateContractPayload {
            amount:       Amount::zero(),
            receive_name: OwnedReceiveName::new_unchecked("sft_market.operatorOf".to_string()),
            address:      contract_address,
...
fn initialize_contract_with_alice_tokens() -> (Chain, ContractAddress, ContractInvokeSuccess) {
    ...
    let update = chain
        .contract_update(SIGNER, ALICE, ALICE_ADDR, Energy::from(10000), UpdateContractPayload {
            amount:       Amount::zero(),
            receive_name: OwnedReceiveName::new_unchecked("sft_market.mint".to_string()),
            address:      contract_address,
...
fn initialize_chain_and_contract() -> (Chain, ContractAddress) {
    ...
    let init = chain
        .contract_init(SIGNER, ALICE, Energy::from(10000), InitContractPayload {
            ...
            init_name: OwnedContractName::new_unchecked("init_sft_market".to_string()),
